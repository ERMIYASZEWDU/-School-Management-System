    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 pt-8">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">{t('teacher.yourWeeklySchedule', 'Your weekly teaching schedule')}</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">{t('teacher.noTimetableAvailable', 'No timetable available')}</p>
          </div>
        ) : (
